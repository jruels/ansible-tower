...
- Creating an SSH key, and confirming access
...
You should see output showing the ansible version
...
## Log into the Ansible Tower webpage
Load https://[CONTROL_NODE_IP_ADDRESS] in a web browser
